defmodule TextbinWeb.UserAuth do
  ...
  @remember_me_cookie "_textbin_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      TextbinWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the `current_scope`:
      ...
      defmodule TextbinWeb.PageLive do
        use TextbinWeb, :live_view

        on_mount {TextbinWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{TextbinWeb.UserAuth, :require_authenticated}] do
