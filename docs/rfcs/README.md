...
| RFC | Status | Covers |
|---|---|---|
| [0001: Administration](0001-administration.md) | Draft | Platform administrators, authorization, bootstrap, moderation, and internal views |
| [0002: Self-hosting documentation](0002-self-hosting-documentation.md) | Draft | Operator documentation for deploying and recovering the portable image |
