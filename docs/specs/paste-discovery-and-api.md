...
1. exact/prefix metadata search over title and filename;
2. PostgreSQL full-text search for eligible text paste bodies;
3. tags and advanced filters only after their data model is specified.
